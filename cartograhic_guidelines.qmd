...
subtitle: Part 3 - Cartographic Guidelines  
date: today
author:
  - name: 
        family: Krug
...
citation:
  type: report
  container-title: " IPBES Technical Guidelines: Part 3 - Cartographic Guidelines  "
  doi: 10.5281/zenodo.6992222
doi: 10.5281/zenodo.6992222
version: 3.0
...
To access the full guidance and associated files, please go to this website: https://doi.org/10.5281/zenodo.5883632 and request access. Once you have access, download all files and read the full instructions. 
...
* Avoid country borders, if needed country borders are black, continuous, and 0.2 in size and follow the guidance available on Zenodo (https://doi.org/10.5281/zenodo.5883632) 
...
-   Administrative borders: <https://gadm.org/data.html>
-   Standardizing country names:
    -   ISO 3166-1 alpha 3 (<https://www.iso.org/iso-3166-country-codes.html>) codes should be used
...
-   Coast lines, land, and ocean boundaries: <https://www.naturalearthdata.com/downloads/>
